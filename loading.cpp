...
{
	//로딩화면 백그라운드 이미지 초기화
	_background = IMAGEMANAGER->addImage("image/loading/bgLoadingScene", "image/loading/bgLoadingScene.bmp", WINSIZEX, WINSIZEY);

	//로딩바 초기화
	_loadingBar = new progressBar;
	_loadingBar->init("image/loading/loadingBarFront", "image/loading/loadingBarBack", 0, WINSIZEY - 20, WINSIZEX, 20);
